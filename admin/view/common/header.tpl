...
<div class="top-bar">
    <a href="/admin" class="main-page">ГЛАВНАЯ</a>
    <div class="login-error"><?= App::$registry->errors['loginError'] ?></div>
    <?php if ( App::$registry->authorise['login'] ): ?>
        <div class="logged-greeting">Приветствую, <a id="user-link" href="/admin/user/<?= App::$registry->authorise['id'] ?>"><?= App::$registry->authorise['name'] ?></a></div>
        <div class="logout">
